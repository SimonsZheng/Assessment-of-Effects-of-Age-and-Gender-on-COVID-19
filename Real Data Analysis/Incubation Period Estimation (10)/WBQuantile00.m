function [ mean_Quantile ] = WBQuantile00( lambda_hat, alpha_hat, beta_hat )
...
% for male group with gge < 45 when the estimates of the parameters through
% the pool data are (lambda_hat, alpha_hat, beta_hat).
a = alpha_hat;
temp = lambda_hat.*exp(beta_hat*[0;0]);
b = 1./(temp);
mean = b.*(gamma(1+1./a));
