function [ gamma_hat ] = Efunction( data,Newdata,N,n,lambda,alpha,beta,theta )
...
Ntor = exp(Log_Weibull(Newdata,n,lambda,alpha,beta)).*Pi+0.00000000001;
Dtor = Ntor + exp(Log_LengthBiased_Weibull(Newdata,n,lambda,alpha,beta)).*(1-Pi)+0.00000000001;
gamma_hat = Ntor./Dtor;
end
