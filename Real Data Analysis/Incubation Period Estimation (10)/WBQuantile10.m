function [ mean_Quantile ] = WBQuantile10( lambda_hat, alpha_hat, beta_hat )
...
% for female group with age < 45 when the estimates of the parameters thro-
% ugh the pool data are (lambda_hat, alpha_hat, beta_hat).
a = alpha_hat;
temp = lambda_hat.*exp(beta_hat*[1;0]);
b = 1./(temp);
mean = b.*(gamma(1+1./a));
