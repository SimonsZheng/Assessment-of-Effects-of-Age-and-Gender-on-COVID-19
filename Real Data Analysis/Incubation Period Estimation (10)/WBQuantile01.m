function [ mean_Quantile ] = WBQuantile01( lambda_hat, alpha_hat, beta_hat )
...
% for male group with age >= 45 when the estimates of the parameters throu-
% gh the pool data are (lambda_hat, alpha_hat, beta_hat).
a = alpha_hat;
temp = lambda_hat.*exp(beta_hat*[0;1]);
b = 1./(temp);
mean = b.*(gamma(1+1./a));
