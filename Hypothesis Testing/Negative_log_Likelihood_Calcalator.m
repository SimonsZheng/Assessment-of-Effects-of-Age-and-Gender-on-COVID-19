function [ Negative_log_Likelihood ] = Negative_log_Likelihood_Calcalator( data, Para, theta, N, n)
...
Negative_log_Likelihood = -sum(log(PI.*exp(Log_Weibull(data,n,lambda,alpha,beta))+(1-PI).*exp(Log_LengthBiased_Weibull(data,n,lambda,alpha,beta))));
end
