function [ Likelihood ] = Hypothesis_Test1( Data,bound_vector, K, I, epsilon, T, N, n, n_add_one, Para_num)
% This is a subroutine program to calculate the likelihood without constra-
% ints for beta.
% Input: 
...
%       for K simulated datasets without constraints for beta.
...
log_Likelihood_output = -Negative_log_Likelihood_Calcalator( data, Para_estimator, theta_estimator, N, n);
...
temp_log_Likelihood_output  = -Negative_log_Likelihood_Calcalator( data, Para_estimator, theta_estimator, N, n);
